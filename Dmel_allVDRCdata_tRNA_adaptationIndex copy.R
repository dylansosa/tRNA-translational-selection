...
write.table(dmel.youngE.tai, file = 'dmel.vdrc.youngE.tai.txt',sep = '\t',quote = F)
...
# calculate tRNA adaptation index 
write.table(dmel.youngNE.tai, file = 'dmel.vdrc.youngNE.tai.txt',sep = '\t',quote = F)
...
# calculate tRNA adaptation index 
write.table(dmel.ancientE.tai, file = 'dmel.vdrc.ancientE.tai.txt',sep = '\t',quote = F)
...
# calculate tRNA adaptation index 
write.table(dmel.ancientNE.tai, file = 'dmel.vdrc.ancientNE.tai.txt',sep = '\t',quote = F)
...
youngEresults <- read.csv('dmel.vdrc.youngE.tai',sep = '\t',header = F)
ancientEresults <- read.csv('dmel.vdrc.ancientE.tai',sep = '\t',header = F)
youngNEresults <-read.csv('dmel.vdrc.youngNE.tai',sep = '\t',header = F)
ancientNEresults <- read.csv('dmel.vdrc.ancientNE.tai',sep = '\t',header = F)
...
ggsave(groupDensity, filename = '/Users/dylansosa/Documents/UChicago/Long Lab/Projects/Thesis Projects/prediciton_essential_gene_evolution/code/tRNA/figures/vdrc_groupDensity.png')

totalYoungresults <- read.csv('dmel.vdrc.young.tai',sep = '\t',header = F)
totalAncientresults <- read.csv('dmel.vdrc.ancient.tai',sep = '\t',header = F)

n <- ggplot(totalYoungresults) +
  geom_density(aes(V2)) +
  labs(title = 'all young gene tAI')
...
youngDeNovoDensity <- read.csv('dmel.vdrc.young.deNovo.tai',sep = '\t',header = F)
